...
namespace Catch {
    ...
    auto Stopwatch::getElapsedNanoseconds() const -> unsigned int {
        return static_cast<unsigned int>(getCurrentNanosecondsSinceEpoch() - m_nanoseconds);
    }
    auto Stopwatch::getElapsedMicroseconds() const -> unsigned int {
        return static_cast<unsigned int>(getElapsedNanoseconds()/1000);
    }
    auto Stopwatch::getElapsedMilliseconds() const -> unsigned int {
        return static_cast<unsigned int>(getElapsedMicroseconds()/1000);
    }
    auto Stopwatch::getElapsedSeconds() const -> double {
